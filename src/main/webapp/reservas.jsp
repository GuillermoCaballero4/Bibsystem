...
cargardetalle();
  ...
  var cantidadReserva = $("#cantidad_reserva").val();
  ...
  if (parseInt(cantidadReserva, 10) > cantidadDisponible) {
  ...
  if (parseInt(cantidadReserva, 10) <= 0) {
    alert("La cantidad de libros que intenta reservar es inválida.");
    return;
  }
