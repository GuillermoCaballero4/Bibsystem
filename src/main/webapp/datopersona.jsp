<%-- 
    Document   : reportpersona
    Created on : 20 ago. 2024, 17:44:03
    Author     : david
--%>
...
<%    try {
        ...
        File reportFile = new File(application.getRealPath("reportes/unopersona.jasper"));
        /**/
