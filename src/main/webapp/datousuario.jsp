<%-- 
    Document   : datousuario
    Created on : 3 sept. 2024, 18:02:13
    Author     : david
--%>
...
<%    try {
        ...
        File reportFile = new File(application.getRealPath("reportes/unousuario.jasper"));
        /**/
