<%-- 
    Document   : reportreservadetalle
    Created on : 26 nov. 2024, 20:19:42
    Author     : david
--%>
...
<%
    ...
    try {
        ...
        File reportFile = new File(application.getRealPath("reportes/informereservadetalle.jasper"));
        ...
        if (idfechaa != null && idfechab != null) {
            ...
            parametros.put("titulo_libro", titulo_libro);
