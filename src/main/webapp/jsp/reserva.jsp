...
// Para listar el detalle
    ...
    try {
        ...
        if (pk.next()) { // Verifica si se encontró un resultado
            ...
            if (!rs.next()) { // Si no hay resultados en la consulta, muestra el mensaje
                out.println("");
            } else {
                // Si hay resultados, comienza a imprimir los datos
                do {
                    %>
                    <tr>
                    ...
                    <%
                } while (rs.next()); // Repite mientras haya más resultados
            }
        } else {
            out.println("");
        }
